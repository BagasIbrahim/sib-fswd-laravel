        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                ...
                <div>
                    ...
                    <a class="text-light" href="https://www.instagram.com/b_maulanaibrahim/" target="_blank"><i class="fab fa-instagram fa-sm fa-fw me-2"></i></a>
                    <a class="text-light" href="https://github.com/BagasIbrahim" target="_blank"><i class="fab fa-github fa-sm fa-fw me-2"></i></a>
                    <a class="text-light" href="https://www.linkedin.com/in/bagas-maulana-ibrahim/" target="_blank"><i class="fab fa-linkedin fa-sm fa-fw"></i></a>
                </div>
            </div>
        </div>
    </nav>
        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="{{asset('vendor/img/banner_img_01.jpg')}}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                ...
                                <p>
                                    ...
                                    Sit quam in accusamus tempora dolore, neque adipisci nemo aut dignissimos 
                                    eveniet.
                                </p>
                            </div>
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="{{asset('vendor/img/banner_img_02.jpg')}}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                                    Corrupti soluta sunt iste expedita provident nihil, 
                                    fuga, perferendis officiis earum consequuntur accusamus 
                                    fugiat ut quisquam ducimus totam itaque cupiditate saepe suscipit.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="{{asset('vendor/img/banner_img_03.jpg')}}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
